...
function Login() {
    ...
    return (
        <div className='flex-grow flex items-center justify-center'>
            <form onSubmit={handleLogin} className='w-[30rem] rounded border dark:bg-gray-800 bg-gray-300 border-gray-700 px-3 pt-7 pb-5 mx-[min(3vw,2rem)]'>
                ...
                <Button type='submit' className='block mt-2 mx-auto'>
                    Login
                </Button>
            </form>
        </div>
